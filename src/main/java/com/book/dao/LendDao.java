...
public class LendDao {
    ...
    private final static String BOOK_LEND_SQL_ONE = "INSERT INTO lend_list (book_id,reader_id,lend_date,borrowingDay,book_name,reader_name,return_date,publish,manager) VALUES ( ? , ? , ? ,?,?,?,?,?,?)";
    ...
    private final static String MY_NOT_RETURN = "SELECT * from lend_list where reader_id = ? AND back_date is NULL ";
    ...
    public int bookLendOne(long bookId, int readerId, String borrowingDay, String bookName, String readerName, String returnDate, String publish, String manager) {
        return jdbcTemplate.update(BOOK_LEND_SQL_ONE,
                new Object[]{bookId, readerId, df.format(new Date()), borrowingDay, bookName, readerName, returnDate, publish, manager});
    }
        ...
        jdbcTemplate.query(LEND_LIST_SQL, new RowCallbackHandler() {
            public void processRow(ResultSet resultSet) throws SQLException {
                ...
                while (resultSet.next()) {
                    ...
                    lend.setPublish(resultSet.getString("publish"));
                    lend.setManager(resultSet.getString("manager"));
                    list.add(lend);
                }
            }
        });
    ...
    public List<Lend> myNotReturnBook(String readerId) {
        ...
        jdbcTemplate.query(MY_NOT_RETURN, new Object[]{readerId}, new RowCallbackHandler() {
            public void processRow(ResultSet resultSet) throws SQLException {
                resultSet.beforeFirst();
                while (resultSet.next()) {
                    Lend lend = new Lend();
