...
<div style="position: relative;top: 10%;width: 80%;margin-left: 10%">
    ...
    <form action="${ctx }/bookDictionaries/saveBook" method="get" id="addbook">
        ...
        <div class="form-group">
            ...
            <a href="http://ztflh.xhma.com/" target="_blank"><button class="btn btn-success btn-xs" type="button" >去查询</button></a>
            <input type="text"placeholder="请输入分类号" class="form-control" name="classId" id="classId">
        </div>
        <div class="form-group">
            <label for="pubdate">书籍来源</label>
            <input type="text" class="form-control" name="bookSource" id="bookSource">
        </div>
