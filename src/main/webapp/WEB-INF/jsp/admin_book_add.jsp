...
<body>
	<nav style="position:fixed;z-index: 999;width: 100%;background-color: #fff"
	...
	<div style="position: relative;top: 10%;width: 80%;margin-left: 10%">
		<form action="book_add_do.html" method="post" id="addbook">
			...
			<div class="form-group">
				<label for="classId">分类号</label> <input type="text"
			...
			<div class="form-group">
				<label for="state">状态</label> <input type="text"
					class="form-control" name="state" id="state" placeholder="请输入图书状态">
			</div>
