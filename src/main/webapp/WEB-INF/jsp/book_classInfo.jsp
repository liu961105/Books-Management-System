...
<div style="padding: 70px 550px 10px">
    <form   method="post" action="querybook.html" class="form-inline"  id="searchform">
        <div class="input-group">
           <input type="text" placeholder="分类名" class="form-control" id="search" name="searchWord" class="form-control">
        ...
        <table class="table table-hover">
            ...
            <tr>
               ...
               <%--  <c:if test="${book.state==1}">
                ...
                <td><a href="bookdetail.html?bookId=<c:out value="${classInfo.classId}"></c:out>"><button type="button" class="btn btn-success btn-xs">详情</button></a></td>
                <td><a href="updatebook.html?bookId=<c:out value="${classInfo.classId}"></c:out>"><button type="button" class="btn btn-info btn-xs">编辑</button></a></td>
                <td><a href="deletebook.html?bookId=<c:out value="${classInfo.classId}"></c:out>"><button type="button" class="btn btn-danger btn-xs">删除</button></a></td>
            </tr>
            </c:forEach>
            </tbody>
        </table>
