    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle"
                                        data-toggle="dropdown"> 基础数据管理 <b class="caret"></b>
                </a>
                    <ul class="dropdown-menu">
                        <li><a href="${ctx}/classInfo/getClassInfo">图书分类</a></li>
                        <li><a href="${ctx }/classInfo/toAddClassInfo">图书分类维护</a></li>
                        <li class="divider"></li>
                        ...
                        <li class="divider"></li>
                        <li><a href="${ctx}/getBookPressmark">书架管理</a></li>
                        <li><a href="${ctx}/toAddBookPressmark">书架维护</a></li>
                    </ul>
                </li>
